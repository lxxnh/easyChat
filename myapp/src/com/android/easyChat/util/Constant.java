...
public class Constant {
    ...
    // 自定义Action
    public static final String updateMyInformationAction = "com.android.easyChat.updateMyInformation";
    public static final String personHasChangedAction = "com.android.easyChat.personHasChanged";
    public static final String hasMsgUpdatedAction = "com.android.easyChat.hasMsgUpdated";
    public static final String receivedSendFileRequestAction = "com.android.easyChat.receivedSendFileRequest";
    public static final String refuseReceiveFileAction = "com.android.easyChat.refuseReceiveFile";
    public static final String remoteUserRefuseReceiveFileAction = "com.android.easyChat.remoteUserRefuseReceiveFile";
    public static final String dataReceiveErrorAction = "com.android.easyChat.dataReceiveError";
    public static final String dataSendErrorAction = "com.android.easyChat.dataSendError";
    public static final String whoIsAliveAction = "com.android.easyChat.whoIsAlive";// 询问当前那个Activity是激活状态
    public static final String imAliveNow = "com.android.easyChat.imAliveNow";
    public static final String remoteUserUnAliveAction = "com.android.easyChat.remoteUserUnAlive";
    public static final String fileSendStateUpdateAction = "com.android.easyChat.fileSendStateUpdate";
    public static final String fileReceiveStateUpdateAction = "com.android.easyChat.fileReceiveStateUpdate";
    public static final String addFriendRequestAction = "com.android.easyChat.addFriendRequestAction";
    public static final String receiveAddFriendAction = "com.android.easyChat.receiveAddFriendAction";
    public static final String refuseAddFriendAction = "com.android.easyChat.refuseAddFriendAction";
    public static final String agreeAddFriendAction = "com.android.easyChat.agreeAddFriendAction";
    public static final String personApplyAction = "com.android.easyChat.personApplyAction";
    public static final String agreeApplyAction = "com.android.easyChat.agreeApplyAction";
    public static String refuseApplyAction = "com.android.easyChat.refuseApplyAction";
    public static String fileReceiveOrSendFinished = "com.android.easyChat.fileReceiveOrSendFinished";
